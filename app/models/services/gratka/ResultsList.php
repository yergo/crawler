...
class ResultsList extends ResultsListAbstract
{
	...
	public function __construct($url, $content = false, $page = 0)
	{
		...
		/*
		 * przymorze - quik - http://dom.gratka.pl/mieszkania-sprzedam/lista/pomorskie,gdansk,przymorze,on,2,dz,zi,lpo.html
		 * przymorze - full	- http://dom.gratka.pl/mieszkania-sprzedam/lista/pomorskie,gdansk,przymorze,on,on,2,dz,zi,za,lpo.html
		 * wrzeszcz- full	- http://dom.gratka.pl/mieszkania-sprzedam/lista/pomorskie,gdansk,wrzeszcz,on,on,2,dz,zi,za,lpo.html
		 * oliwa- full		- http://dom.gratka.pl/mieszkania-sprzedam/lista/pomorskie,gdansk,oliwa,on,on,2,dz,zi,za,lpo.html
		 * zaspa- full		- http://dom.gratka.pl/mieszkania-sprzedam/lista/pomorskie,gdansk,zaspa,on,on,2,dz,zi,za,lpo.html
		 * żabianka- full	- http://dom.gratka.pl/mieszkania-sprzedam/lista/pomorskie,gdansk,zabianka,on,on,2,dz,zi,za,lpo.html
		 */
